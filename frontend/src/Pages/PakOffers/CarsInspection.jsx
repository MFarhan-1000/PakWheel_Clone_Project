...
export default function CarServices() {
  ...
  const handleSubmit = () => {
    console.log(form);
    alert(`You form is Submitted See you on ${form.date} For Your Car Inspection`);
  };
      ...
      <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-10 items-center">
        ...
        <div>
          <h2 className="text-3xl font-bold text-blue-900 mb-4">
            Car Inspection When you want
          </h2>
          <p className="text-gray-700 mb-8">
            Need reliable car Inspection without the hassle? Book trusted
            mechanics for inspections. Sit back while
